...
console.log('\x1b[40m');
log('Running copyExtensionFolderToIosProject hook, copying widget folder ...', 'start');
...
module.exports = function (context) {
    ...
    fs.readdir(iosFolder, function (err, data) {
        ...
        srcFolder = path.join(context.opts.projectRoot, 'www', projectName + ' Widget/');
        if (!fs.existsSync(srcFolder)) {
            log('Missing widget folder in www folder. Should be named "<PROJECTNAME> Widget"', 'error');
        }
